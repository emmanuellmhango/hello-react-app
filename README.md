...
```sh
  ...
  git clone https://github.com/emmanuellmhango/hello-rails-react.git
```
...
- GitHub: [@githubhandle](https://github.com/emmanuellmhango)
- LinkedIn: [LinkedIn](www.linkedin.com/in/emmanuellmhango)
